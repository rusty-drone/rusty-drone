use rust_architecture::{events::{event_handler::EventHandler, impulse_event::ImpulseEvent}, streams::{constant_stream::ConstantStream, stream::Stream}, components::{pure_component::PureComponent, component::Component}, tasks::{finite_task::FiniteTask, task::Task, sequential_task::SequentialTask}};
use core::time;
